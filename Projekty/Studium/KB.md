# KB — Studium (operační detaily)

Načítá se on-demand, když je potřeba hloubka. Drž to aktuální — zastaralý fakt je horší než žádný.
...
Předměty shodné mezi všeobecným a zubním lékařstvím se na ZL uznávají. Praktický dopad: **1. ročník ZL je pro Tessu výrazně odlehčený** oproti standardnímu studentovi.

- Uznáno: *(doplnit ze studijního plánu / rozhodnutí o uznání — čeká na tabulku ze SharePointu)*
- ⚠️ **Má Tessa písemné rozhodnutí o uznání?** Ústní příslib studijního oddělení není totéž. → viz Otevřené otázky
...
Sem patří všechno, co se o zkoušení zjistí — od spolužaček, z vlastní zkušenosti, z `Feedback/`. **Tohle je nejcennější obsah celého souboru**, protože podle něj se dá triážovat, co se učit pořádně.

| Předmět | Forma | Co skutečně chtějí | Zdroj informace |
|---|---|---|---|
| | | | |

> Výhoda oproti běžnému prváku: dva roky na téže fakultě = Tessa už zná spoustu kateder a zkoušejících z VL. Cokoli si z toho pamatuje, patří sem.

## Materiály

| Předmět | Hlavní zdroj | Kde to je |
|---|---|---|
| | | |
