# Speciální farmakologie II — na ústní zkoušku · otázka 126

*Oficiální číslování. Zdroj: `Inputs/specka2-podrobna-cast1-CITELNA.pdf`, s. 67–71*

---

# 126 — Léčiva používaná pro místní účinek na kůži a sliznicích (+ dezinficiencia)

> **Kostra:** typy dermatologické léčby → **na čem závisí zevní účinek a průnik** → lékové formy → **externa podle účinku** → hlavní léčiva → ⚠️ **koncentrační řady** → oficiální přípravky → **dezinficiencia × antiseptika**

**Léčba v dermatologii:** **zevní (lokální)** · **celková (systémová)** · **fyzikální** (chirurgická, fototerapie, kryoterapie)
⚠️ **Úspěch závisí na správné diagnóze, fázi choroby a koncentraci zevního léku.**

## Zevní léčba — na čem stojí
...
|---|---|---|
| Kde působí | ⚠️ **ve vnějším prostředí — na neživých předmětech**, plochách, nástrojích, v infekčním materiálu | ⚠️ **v prostředí živých tkání** — kůže, rána, sliznice |
| Cíl | **usmrcení mikroorganismů** | **zneškodnění (inhibice růstu)** |
| Podmínka | ⚠️ **nejvyšším stupněm dezinfekce je sterilizace** | ⚠️ **v koncentracích, které nepoškodí zdravé tkáně** |
