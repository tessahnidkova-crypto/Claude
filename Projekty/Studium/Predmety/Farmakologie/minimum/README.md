...
| Téma | Kde |
|---|---|
| **Xerostomie a mnohočetný kaz** (anticholinergika, TCA, antipsychotika, inhalancia) | Specka I 39, 55 · Specka II 96, 97 |
| **Anestezie nezabírá v zaníceném zubu** (iontová past) | Specka I 48 |
| **Fenytoin → hyperplazie dásní** (+ cyklosporin, blokátory Ca) | Specka I 53 · Specka II 114 |
| **SSRI → delší krvácení po extrakci** | Specka I 57 |
| **Ibuprofen vs. paracetamol po výkonu** | Specka I 63 |
| **Penicilin V = lék volby v ústech** | Specka I 83 |
| **Klindamycin = kost + absces + anaeroby** | Specka I 86 |
| **Tetracyklin barví zub zevnitř, nedá se vybělit** | Specka I 87 |
| **Oxycelulóza, kolagenová houbička, tranexamová kyselina po extrakci** | Specka I 78 |
| **Warfarin a aspirin před extrakcí — nevysazovat automaticky** | Specka I 77, 79 |
| **Kortikoidy: před zákrokem VYŠŠÍ dávka** | Specka II 117 |
| **Fluoroapatit + osteonekróza čelisti po bisfosfonátech** | Specka II 130 |
| **Chlorhexidin — hnědé zbarvení a porucha chuti** | Specka II 126 |
| **Vitamin C → krvácení z dásní a viklající se zuby** | Specka II 129 |
