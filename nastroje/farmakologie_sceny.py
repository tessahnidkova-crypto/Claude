...
S("81", "Perorální antidiabetika",
  ...
  [("1️⃣", "Metformin v čele", False, "PRVNÍ VOLBA u diabetu 2. typu — snižuje jaterní glukoneogenezi a zvyšuje citlivost k inzulinu. Nezpůsobuje hypoglykemii ani přírůstek hmotnosti."),
   ("⚠️", "Laktátová acidóza", True, "Metformin je kontraindikován při renální insuficienci, hypoxii, těžkém jaterním onemocnění a alkoholismu; před jodovou kontrastní látkou a před operací se VYSAZUJE. Dále průjem, nauzea a deficit vitaminu B12."),
   ...
   ("💉", "GLP-1 agonisté", False, "Liraglutid, semaglutid, dulaglutid — zpomalují vyprazdňování žaludku, zvyšují sytost, snižují hmotnost a kardiovaskulární riziko; nauzea, riziko pankreatitidy. Gliptiny (sitagliptin) jsou hmotnostně neutrální."),
